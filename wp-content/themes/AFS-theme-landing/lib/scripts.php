...
function roots_scripts() {
  wp_enqueue_style('roots_app', get_template_directory_uri() . '/assets/css/app.css', false, '9a2dd99b82ca338b034e8730b94139d2');
...
<script>
  ...
  ga('create', '<?php echo GOOGLE_ANALYTICS_ID; ?>', 'facilityvendor.com');
  ga('send', 'pageview');
