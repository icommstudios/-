<?php
global $contractor_id, $user_fields;

//Get messages
$messages_to_id = $contractor_id;
//Build args
...
<?php else : ?>
     ...
     <article class="content-item general msg_project_invite">
      ...
      <span style="display: none;" class="related_project_title"><?php echo get_the_title($related_project_id); ?></span>
		  <?php if ( $related_project_action == 'project_accept' ) : ?>
            ...
            <a href="<?php echo add_query_arg(array('action' => 'jobs', 'prop_edit' => '', 'prop_m' => $message_id, 'prop_p' => $related_project_id), SF_Users::user_profile_url()); ?>" class="btn">submit proposal</a>
    ...
    <?php
     ...
     <?php
		} elseif ($type == 'proposal_reminder') {
	  ?>
     <article class="content-item general msg_proposal_reminder">
        <h4 class="content-title"><a href="#"><?php echo get_the_title($message_id); ?></a></h4>
        <p class="content-summary">please submit your best proposal.</p>
      <div class="content-meta">
        <p class="author">from <a href="<?php echo get_permalink($from_id); ?>" rel="author" class="fn"><?php echo get_the_title($from_id); ?></a></p>
      </div>
      <a href="<?php echo add_query_arg(array('action' => 'jobs', 'prop_edit' => '', 'prop_m' => $message_id, 'prop_p' => $related_project_id), SF_Users::user_profile_url()); ?>" class="btn">submit proposal</a>
      ...
      ?>
     <article class="content-item general msg_proposal_accept">
        <h4 class="content-title"><a href="#"><?php echo get_the_title($message_id); ?></a></h4>
        <p class="content-summary">proposal has been accepted.</p>
      <div class="content-meta">
        <p class="author">from <a href="<?php echo get_permalink($from_id); ?>" rel="author" class="fn"><?php echo get_the_title($from_id); ?></a></p>
      </div>
    ...
    <article class="content-item general msg_project_completed">
      ...
      <?php
	  //remove endorsement for contractor
	  /* 
     ...
     <?php
		} elseif ($type == 'project_deadline_reminder') {
	 ?>
     <article class="content-item general msg_project_deadline_reminder">
        <h4 class="content-title"><a href="#"><?php echo get_the_title($message_id); ?></a></h4>
        <p class="content-summary"><?php echo wp_trim_excerpt(get_post_field('post_content', $message_id)); ?></p>
      <div class="content-meta">
        <p class="author">from <a href="<?php echo get_permalink($from_id); ?>" rel="author" class="fn"><?php echo get_the_title($from_id); ?></a></p>
